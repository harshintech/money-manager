...
import in.harshintech.moneymanger.repository.ProfileRepository;
    ...
    public void sendDailyIncomeExpenseReminder(){
        ...
        for(ProfileEntity profile : profiles){
            String body = "Hi " + profile.getFullName() + ",<br><br>"
                    ...
                    + "Go to Money Manger</a>"
                    + "<br><br>Best regards,<br>Money Manager Team,<br> By Harsh in Tech";
    ...
    public void sendDailyExpensesSummary(){
        ...
        for(ProfileEntity profile : profiles){
            ...
            if(!todayExpenses.isEmpty()){
                ...
                table.append("</table>");
                String body = "Hi " + profile.getFullName() + ",<br/><br/> Here is a summary of your expenses for today:<br/><br/>"+table+"<br/><br/>Best regards,<br/>Money Manger Team<br/>by Harsh in Tech";
