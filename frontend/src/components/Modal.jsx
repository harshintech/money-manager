  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-center items-center w-full h-full overflow-hidden bg-black/40 backdrop-blur-sm">
      <div className="relative p-4 w-full max-w-2xl max-h-[90vh]">
        {/* Modal Header */}
        <div className="relative bg-white/70 rounded-xl shadow-2xl border border-purple-600 backdrop-blur-md">
          {/* Modal Content */}
          <div className="flex items-center justify-between p-5 md:p-6 border-b border-purple-600 rounded-t-xl">
